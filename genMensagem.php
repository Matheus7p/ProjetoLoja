    ...
    <div class="container" style="margin-top:20px ; background-color: rgba(0, 53, 103, 0.7); padding: 110px;">
        <div class="overflow-auto">
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col" style='text-align:center; color:white;'><b>Assunto</b></th>
                        <th scope="col" style='text-align:center; color:white;'><b>Observação</b></th>
                        <th scope="col" style='text-align:center; color:white;'><b>Data</b></th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
                        ...
                        while($row = $resultado->fetch()){
                            echo "<tr>";
                            echo "<td style='text-align:center; color:white;'>".$row['assunto']."</td>";
                            echo "<td style='text-align:center; color:white;'>".$row['obs']."</td>";
                            echo "<td style='text-align:center; color:white;'>".$row['mensagemdata']."</td>";
                            echo "<td> 
                            ...
                            <div class='modal-dialog'>
                              <div class='modal-content'>
                                ...
                                <div class='modal-footer'>
                                  ...
                                  <a class='btn btn-danger' href='deleteMensagem.php?codMensagem=$row[codMensagem]'>Confirmar</a>
                                </div>
                              </div>
                            </div>
                          </div>
